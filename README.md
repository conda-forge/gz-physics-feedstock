...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/gz-physics-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/gz-physics-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add gz-physics libgz-physics
# for installing globally
pixi global install gz-physics libgz-physics
```
...
It is possible to list all of the versions of `gz-physics` available on your platform:
...
```
pixi search gz-physics --channel conda-forge
```
